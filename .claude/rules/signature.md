...
## RULE-SIG-PERSIST-03: Persisted signature buckets older than PersistedEvictionAge MUST be evicted at daemon start before warm-restart.

`Library.EvictPersistedBefore(kv, cutoff time.Time) (deleted int, err error)`
...
Bound: internal/signature/persistence_test.go:TestEvictPersistedBefore_CorruptBucketIsDeleted
Bound: internal/signature/persistence_test.go:TestEvictPersistedBefore_DanglingManifestEntryIsPruned
Bound: internal/signature/persistence_test.go:TestEvictPersistedBefore_FreshBucketsSurvive
Bound: internal/signature/persistence_test.go:TestPersistedEvictionAge_Is30Days

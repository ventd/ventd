# spec-03 — Hardware profile library

**Masterplan IDs:** P5-PROF-01, P5-PROF-02 (foundation for profile flywheel)
**Target release:** v0.5.0 → v0.7.0 rolling
...
|----|-------------|--------|
| PR 1 | Schema v1 freeze (RULE-HWDB-01..09, profiles-v1.yaml) | merged (#629) |
| PR 2a | Three-tier matcher + chip-family catalog (RULE-HWDB-PR2-01..14) | this PR |
| PR 2b | Calibration probe + apply path | planned |
| PR 2c | Diagnostic bundle dump | planned |
